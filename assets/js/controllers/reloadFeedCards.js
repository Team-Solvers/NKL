...
export async function reloadCards(user_id,content,title,post_id){
    let postTime = new Date(Date.now() * 1000);
    let postCardFromDB = getPostCard(imgLink,title,user_id,postTime,content,0,post_id,false,false);
